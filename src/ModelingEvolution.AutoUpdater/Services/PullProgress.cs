...
namespace ModelingEvolution.AutoUpdater.Services
{
    ...
    /// <param name="BytesPercent">Download completion 0-100 (<paramref name="BytesDownloaded"/> / <paramref name="BytesTotal"/>); 100 once every image is pulled; null while no layer size is known or some layer is not sized; below 100 when an image failed.</param>
    ...
    /// <param name="ImagesFailed">Images compose reported as failed; they are among <paramref name="ImagesPulled"/> (finished) but their bytes were not downloaded.</param>
